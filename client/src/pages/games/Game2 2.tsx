          ...
          <>
            ...
            <SpaceSnake 
              onGameStateChange={(isPlaying) => {
                ...
                if (!isPlaying && hasPlayedGame && !gameEnded) {
                  // Game ended - submit score (score needs to be obtained from game component)
                  setGameEnded(true);
                  // TODO: Get actual score from SpaceSnake component
                  const score = 0; // Placeholder
                  if (score && score > 0) {
                    submitGameResult(score, 'game2');
                  }
                }
              }} 
            />
