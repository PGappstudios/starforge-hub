...
import { submitGameResult } from "@/api/game"; // Assuming this API call is available
            ...
            <div className="space-y-4">
              ...
              <MemoryCardGame
                onGameStateChange={(playing) => {
                  ...
                  if (!playing && hasPlayedGame && !gameEnded) {
                    // Game ended - submit score (we'll use a mock score for now)
                    setGameEnded(true);
                    submitGameResult(1000, 'game3');
                  }
                }}
              />
            </div>
