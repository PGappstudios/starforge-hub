...
export interface CargoGameState {
  ...
  gameStatus: 'menu' | 'playing' | 'paused' | 'gameOver' | 'levelComplete' | 'timeUp';
  score: number;
  totalItems: number;
...
export const CARGO_CONFIG = {
  ...
  // Item definitions with weights and points
  ITEM_DEFINITIONS: {
    // Heavy items (weight 3)
    ARCO: { weight: 3, points: 150, fileName: 'ARCO.png' },
    DIAMOND: { weight: 3, points: 200, fileName: 'DIAMOND.png' },
    ROCH: { weight: 3, points: 175, fileName: 'ROCH.png' },
    
    // Light items (weight 1)
    SDU: { weight: 1, points: 25, fileName: 'SDU.png' },
    AGEL: { weight: 1, points: 30, fileName: 'AGEL-57k3FPK3Uq1Vrp02.png' },
    CARBON: { weight: 1, points: 20, fileName: 'CARBON.png' },
    CRYSLAT: { weight: 1, points: 35, fileName: 'CRYSLAT.png' },
    ENRGSUB: { weight: 1, points: 40, fileName: 'ENRGSUB.png' },
    FSTAB: { weight: 1, points: 45, fileName: 'FSTAB-uG0HGWxwZeOsKidv.png' },
    HYG: { weight: 1, points: 25, fileName: 'HYG.png' },
    IC3A: { weight: 1, points: 30, fileName: 'IC3A.png' },
    LUMAN: { weight: 1, points: 35, fileName: 'LUMAN.png' },
    NITRO: { weight: 1, points: 40, fileName: 'NITRO-wmxKLSXK8vkZc9IY.png' },
    POLYMER: { weight: 1, points: 25, fileName: 'POLYMER.png' },
    PRTACL: { weight: 1, points: 30, fileName: 'PRTACL.png' },
    PWRSRC: { weight: 1, points: 50, fileName: 'PWRSRC.png' },
    RADABS: { weight: 1, points: 45, fileName: 'RADABS.png' }
