...
const GAMES_CONFIG = {
  1: { name: "Space Shooter", pointsMultiplier: 2 },
  2: { name: "Space Snake", pointsMultiplier: 1.5 },
  3: { name: "Memory Match", pointsMultiplier: 3 },
  4: { name: "Star Atlas Quiz", pointsMultiplier: 2.5 },
  5: { name: "Puzzle Master", pointsMultiplier: 2 },
  6: { name: "Resource Runner", pointsMultiplier: 1.8 }
} as const;
